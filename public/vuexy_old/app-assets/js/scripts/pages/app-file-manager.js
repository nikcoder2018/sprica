...
$(function() {
    ...
    var sidebarFileManager = $('.sidebar-file-manager'),
        ...
        spinner = `
        <div class="spinner-grow spinner-grow-lg text-primary mr-1" style="width: 3rem; height: 3rem" role="status">
    ...
    $('#new-folder-modal').on('submit', 'form', function(e) {
        e.preventDefault();
        let form = $(this);
        $.ajax({
            ...
            data: $(this).serialize(),
            beforeSend: function() {
                fileContentBody.addClass('d-flex align-items-center justify-content-center');
                fileContentBody.html(spinner);
            },
            success: function(resp) {
                if (resp.success) {
                    ...
                    fileContentBody.removeClass('d-flex align-items-center justify-content-center');
                    fileContentBody.html(resp.view);
                }
            }
        })
    });
