    ...
    <div class="navbar-header d-xl-block d-none">
        <ul class="nav navbar-nav">
            ...
            <a class="navbar-brand" href="{{route('home')}}">
                <img style="text-align:center; width: 60%; background: #fff" src="{{asset('dist/img/logo-auth.jpg')}}">
            </a></li>
        </ul>
    </div>
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item d-none d-lg-block">
                <a id="theme-mode-button" class="nav-link nav-link-style" data-status="dark">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                            <div class="media d-flex align-items-start">
                                <div class="media-left">
                                    <div class="avatar"><img
                                            src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-15.jpg') }}"
                            ...
                            <div class="media d-flex align-items-start">
                                <div class="media-left">
                                    <div class="avatar"><img
                                            src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-3.jpg') }}"
                                            alt="avatar" width="32" height="32"></div>
                                </div>
                                <div class="media-body">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                    ...
                    <span class="avatar">
                        <img class="round"
                            src="{{ auth()->user()->avatar ?: asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-11.jpg') }}"
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" href="app-todo.html"><i class="mr-50" data-feather="check-square"></i>
                        Task</a>
                    <a class="dropdown-item" href="app-chat.html"><i class="mr-50" data-feather="message-square"></i>
                        Chats</a>
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/icons/xls.png') }}" alt="png"
                        height="32"></div>
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/icons/jpg.png') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/icons/pdf.png') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/icons/doc.png') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-8.jpg') }}"
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-1.jpg') }}"
                        alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-14.jpg') }}"
                        alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-75"><img
                        src="{{ asset(env('APP_THEME', 'default') . '/app-assets/images/portrait/small/avatar-s-6.jpg') }}"
                        alt="png" height="32"></div>
                <div class="search-data">
