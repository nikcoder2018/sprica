            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form autocomplete="off" enctype="multipart/form-data" class="form-update-language"
                            action="{{ route('admin.settings.language-update') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea class="form-control"
                                                        name="{{ $language->DilBASLIK }}">{{ $language->DilKARSILIK }}</textarea>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
