...
<link rel="stylesheet" type="text/css" href="{{asset(env('APP_THEME','default').'/app-assets/vendors/css/extensions/dragula.min.css')}}">    
@endsection
...
<link rel="stylesheet" type="text/css" href="{{asset(env('APP_THEME','default').'/app-assets/css/pages/app-todo.css')}}">    
@endsection
                        ...
                        <li class="todo-item">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-4.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="todo-item">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-5.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="todo-item completed">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-8.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="todo-item">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="todo-item">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <small class="text-nowrap text-muted mr-1">Aug 28</small>
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-7.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="todo-item">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-17.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="todo-item">
                            <div class="todo-title-wrapper">
                                ...
                                <div class="todo-item-action">
                                    ...
                                    <div class="avatar">
                                        <img src="{{asset(env('APP_THEME','default').'/app-assets/images/portrait/small/avatar-s-2.jpg')}}" alt="user-avatar" height="32" width="32" />
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                <div class="action-tags">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="todoTitleAdd" name="title" class="new-todo-item-title form-control" placeholder="Title" />
                                    </div>
                                    <div class="form-group position-relative">
                                        <label for="task-assigned" class="form-label d-block">Assignee</label>
                                        <select class="select2 form-control" id="task-assigned" name="assigned_user">
                                            @foreach($users as $user)
                                            <option data-img="{{$user->avatar}}" data-prefix="{{strtoupper(substr($user->name, 0, 2))}}" value="{{$user->id}}"  @if($user->name == auth()->user()->name) selected @endif>
                                                {{$user->name == auth()->user()->name? 'Me' : $user->name}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control task-tag" id="task-tag" name="tags[]" multiple="multiple">
                                            @forelse($tags as $tag)
...
<script src="{{asset(env('APP_THEME','default').'/app-assets/vendors/js/extensions/dragula.min.js')}}"></script>
<script src="{{asset(env('APP_THEME','default').'/app-assets/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>    
@endsection

@section('scripts')
<script src="{{asset(env('APP_THEME','default').'/app-assets/js/scripts/pages/app-todo.js')}}"></script>    
@endsection